...
local mappings = {
    ...
    c = {
        name = 'code+',
        a = { function()require('neogen').generate({type = 'func'}) end, 'annotate function'},
        A = { function() require('neogen').generate({type = 'class'}) end, 'annotate class'},
        D = { vim.lsp.buf.declaration, 'go to declaration' },
        d = { vim.lsp.buf.definition, 'go to definition' },
        s = { vim.diagnostic.open_float, 'open diagnostics' },
